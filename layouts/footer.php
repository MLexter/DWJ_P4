    ...
    <div id="footer_infos" class="d-flex justify-content-around align-items-center">
        ...
        <?php if (isset($_SESSION['isAdmin'])) : ?>
            <?php if ($_SESSION['isAdmin'] = true) : ?>
                <a class="footer-item text-center col" id="footer_deconnexion_link" href="<?= HOST; ?>admin/deconnexion"><span id="fa-logout"><i class="fas fa-power-off"></i></span>Déconnexion</a>
