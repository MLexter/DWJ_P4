    ...
    <div id="about_container">
        ...
        <div id="about-container_content" class="shadow border bg-white rounded col-10">
            <div id="about_text_content">
                ...
                <p class="row about_text">Jean Forteroche est un écrivain Suisse né le 12 juillet 1971, passionné d'arts en tous genres et globbe-trotteur. C'est vers la lecture qu'il se tournera très tôt: les classiques Baudelaire, Rimbault, Rousseau ou encore Ferdinand-Céline sont ses premiers coups de coeur avant de se tourner vers des auteurs plus contemporains comme Henry Miller. Une fascination va alors naître pour l'écriture. </p>

                <p class="row about_text">Il publiera une dizaines d'oeuvres entre 1995 et 2015, qui firent de Jean Forteroche un auteur au style décalé mais plein de génie.</p>

                <p class="row about_text">Ses premières idées d'auteur lui viennent très tôt et il décide de les consigner dans un espace très personnel: ses carnets. Il voyage beaucoup à travers le monde et puise son inspiration de ses nombreuses découvertes culturelles. Après plusieurs essais restés personnels, Jean Forteroche publie son nouveau livre: 'Billet simple pour l'Alaska'. </p>

                <p class="row about_text">
                    <br />
                    <span id="quote_text_author" class="border-0">
                ...
                <p class="row about_text">Auteur passionné, Jean Forteroche transpire l'humanité et le réalisme et tient à faire partager au lecteur toute la force de l'évasion par la lecture. <br />
